        ...
        */
        ...
        stage('Run Playbook') {
            steps {
                ...
                sh 'ansible-playbook -i /home/ec2-user/ansible-dev/workspace/Devops/ansible-pipeline/inventory.yml /home/ec2-user/ansible-dev/workspace/Devops/ansible-pipeline'
                 }
                }
            }
        }
